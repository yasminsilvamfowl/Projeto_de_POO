...
public class MAIN {
	public static void main(String[] args) {
		...
		PcDRF pcd = new PcDRF(2);
		es.adicionaEstudante(eS);
		pcd.adicionaEstudante(eS1);
		ac.adicionaEstudante(eS2);
		...
		for(int i = 0; i < es.tamanho() ;i++) {
		   try {
			   ...
			   System.out.println(ppi.getNome() + ": " + ppi.getNota());
		   }catch(PcDException pcd) {
			   System.out.println(pcd.getMessage());
			   System.out.println(pcd.getNome() + ": " + pcd.getNota());
